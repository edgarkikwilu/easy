...
class AuthController extends GetxController{
    ...
    await firebaseAuth.verifyPhoneNumber(
        ...
        verificationFailed: (FirebaseAuthException e){
          ...
          if(e.code == 'invalid-phone-number'){
            ...
            edgeAlert(context,title: "Error!",description: "Invalid phone number entered",backgroundColor: CustomColors.primary,
                icon: Icons.error_outline_outlined, gravity: Gravity.top,duration: 3);
          }else if(e.code == 'too-many-requests'){
            print('too-many-requests');
            edgeAlert(context,title: "Oops!",description: "You have reached maximum attempts. Please wait for an hour!",backgroundColor: CustomColors.primary,
                icon: Icons.check_circle_outline_outlined, gravity: Gravity.top,duration: 5);
          }else{
            edgeAlert(context,title: "Oops!",description: "Third party connection error!",backgroundColor: CustomColors.primary,
                icon: Icons.check_circle_outline_outlined, gravity: Gravity.top,duration: 5);
        ...
        codeSent: (String? verificationId, int? resendToken)async{
          ...
          edgeAlert(context,title: "Success!",description: "Verification code has been sent to ${phoneNumberController.text}",backgroundColor: CustomColors.primary,
              icon: Icons.error_outline_outlined, gravity: Gravity.top,duration: 3);
        },
  ...
  _login(String firebaseIdToken,BuildContext context) async{
    ...
    if(response.statusCode == 200){
      ...
      edgeAlert(context,title: "Success!",description: "You have successfully logged in",backgroundColor: CustomColors.primary,
      ...
      hasAccount = false;
      // Get.to(()=>SignUpScreen());
      edgeAlert(context,title: "Oops!",description: "Account not found",backgroundColor: CustomColors.primary,
          icon: Icons.error_outline_outlined, gravity: Gravity.top,duration: 3);
    }else if(response.statusCode == 404){
      // registerDialog(context);
      hasAccount = false;
      // Get.to(()=>SignUpScreen());
      edgeAlert(context,title: "Oops!",description: "Account not registered",backgroundColor: CustomColors.primary,
          icon: Icons.error_outline_outlined, gravity: Gravity.top,duration: 3);
      ...
      print(response.body);
      print(response.statusCode);
      edgeAlert(context,title: "Oops!",description: "Internal server error. Please try again!",backgroundColor: CustomColors.primary,
          icon: Icons.error_outline_outlined, gravity: Gravity.top,duration: 3);
    }
  }
